...
class Listing extends EtsyRequest {
    ...
    public function createListing(array $parameters = [], array $data = []) {
        return $this->oauth()->requestObject('POST', '/shops/:shop_id/listings', $parameters, $data);
    }
    ...
    public function findAllShopListings(array $parameters = []) {
        return $this->requestCollection('GET', '/shops/:shop_id/listings', $parameters);
    }
