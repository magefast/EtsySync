...
class ListingImage extends EtsyRequest
{
    ...
    {
        return $this->oauth()->requestObject('POST', '/shops/:shop_id/listings/:listing_id/images', $parameters, $data);
    }
     ...
     */
    public function uploadListingImageCurl(array $parameters = [], string $value)
    {
        return $this->requestPOSTimageListing('/shops/:shop_id/listings/:listing_id/images', $parameters, $value);
        //return $this->oauth()->requestObject('POST', '/shops/:shop_id/listings/:listing_id/images', $parameters, $data);
    }
